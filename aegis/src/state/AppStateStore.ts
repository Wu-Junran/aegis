...
import type { PhiMode } from '../medical/audit/AuditLogger.js'
import type { ProviderConfig } from '../medical/providers/ProviderAdapter.js'
import type { Template } from '../medical/templates/Template.js'
...
import { emptyNote } from '../medical/state/currentNote.js'
import type { ValidatorWarning } from '../medical/state/validatorWarnings.js'
...
export type AppState = DeepImmutable<{
  ...
  // Medical — see aegis/src/medical/state/*.ts
  // Kept in the non-DeepImmutable intersection block so consumers see the
  // real Template / PatientContext types (DeepImmutable resolves to
  // `unknown` in this fork, which would erase the field types).
