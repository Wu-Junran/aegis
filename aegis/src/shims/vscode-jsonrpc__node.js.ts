...
export const createMessageConnection: any = _stub;
// deno-lint-ignore no-explicit-any
export const MessageConnection: any = _stub;
// deno-lint-ignore no-explicit-any
export const StreamMessageReader: any = _stub;
// deno-lint-ignore no-explicit-any
export const StreamMessageWriter: any = _stub;
// deno-lint-ignore no-explicit-any
export const Trace: any = _stub;
